    ...
    <div className="min-h-screen bg-[#070b13] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md bg-slate-900/40 border-slate-800/80 backdrop-blur-xl shadow-2xl relative z-10">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-slate-400">Start managing your business documents today</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-slate-300 uppercase tracking-wider">Full Name</label>
            <Input type="text" placeholder="John Doe" className="bg-slate-950/40 border-slate-800 focus-visible:ring-primary/40 text-foreground placeholder:text-slate-600" />
          </div>
          <div className="space-y-1.5">
        ...
        <CardFooter className="flex flex-col space-y-4 pt-2">
          <Link href="/setup-company" className={buttonVariants({ className: "w-full bg-primary hover:bg-primary/95 text-primary-foreground font-semibold" })}>
            Sign Up
          </Link>
